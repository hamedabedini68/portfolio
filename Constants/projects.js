...
export const projects = [
    ...
    {
        name: 'Lexington', //project name
        description: 'Lexington management.', //project description
        githubLink: '', //github repo link
        projectLink: '', //deployed project link
        tech: ['Lighting', 'Improvement', 'Management'], //techstack of the project, it is advisavble to mention only upto 3 technologies here to maintain the ui
